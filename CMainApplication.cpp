...
void CMainApplication::ThreadSleep( unsigned long nMilliseconds )
{
#if defined(_WIN32)
	::Sleep( nMilliseconds );
#elif defined(POSIX)
...
void APIENTRY CMainApplication::DebugCallback(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const char* message, const void* userParam)
{
	printf( "GL Error: %s\n", message );
}
...
const char *CMainApplication::byte_to_binary(int x)
{
    static char b[9];
    b[0] = '\0';
